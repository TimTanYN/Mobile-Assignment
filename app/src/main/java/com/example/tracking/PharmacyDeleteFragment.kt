 ...
 * Use the [PharmacyDeleteFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class PharmacyDeleteFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_pharmacy_delete, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment PharmacyDeleteFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PharmacyDeleteFragment().apply {
