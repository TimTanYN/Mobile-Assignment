 ...
 * Use the [VeganFragment.newInstance] factory method to
...
class VeganFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_vegan, container, false)
...
//        val calories = intent.getDoubleExtra()
    ...
    companion object {
         ...
         * @return A new instance of fragment VeganFragment.
         */
